...
#      "/media/onetbssd/llama/huggingface/7B", 
#      load_in_8bit=True, 
#      device_map='auto',
#  )
...
#tokenizer = AutoTokenizer.from_pretrained("../../../../../../media/onetbssd/llama/huggingface/7B", local_files_only=True)
tokenizer = AutoTokenizer.from_pretrained("/media/onetbssd/llama/huggingface/7B", local_files_only=True)
...
trainer.train()
model.save_pretrained("/media/onetbssd/llama/huggingface/7Btrained")
